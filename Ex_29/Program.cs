...
int a = GetNumber ("Введите минимальное значание массива: "); // пользователь сам выбирает минимальное значение в массиве
int b = GetNumber ("Введите максимальное значание массива: "); // и самостоятельно выбирает макисмальное значение в массиве
